...
if (isset($_POST['add_product'])) {
    ...
    if ($insert_query) {
        ...
        $display_message = "Product inserted succefully";
    } else {
    ...
    <div class="container">
        ...
        <section>
            ...
            <form action="" class="add_product" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="product_image" class="input_fields" required accept="image/png, image/png, image/jpg, image/jpeg">
