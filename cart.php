...
<tbody>";
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <input type="hidden" value="<?php echo
                                                                $fetch_cart_products['id'] ?>" name="update_quantity_id">
                            ...
                            <td><?php echo $subtotal = number_format($fetch_cart_products['price']
            ...
            <div class="table_bottom">
                ...
                <a href="Proceed_to_checkout.php" class="bottom_btn">Proceed to checkout</a>
            </div>
